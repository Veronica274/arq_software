...
"""autogenerated by genpy from softarq_msgs/SequenceActionResult.msg. Do not edit."""
import codecs
import sys
...
class SequenceActionResult(genpy.Message):
  _md5sum = "1de91afd6421e74e9e386c493b82b421"
  _type = "softarq_msgs/SequenceActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','softarq_msgs/SequenceResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = softarq_msgs.msg.SequenceResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = softarq_msgs.msg.SequenceResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.last,) = _get_struct_q().unpack(str[start:end])
      return self
