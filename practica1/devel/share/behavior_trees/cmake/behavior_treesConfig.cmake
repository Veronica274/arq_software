...
if("TRUE" STREQUAL "TRUE")
  set(behavior_trees_SOURCE_PREFIX /home/ruben/arq_software/practica1/src/software_arq_robots_course/behavior_trees)
  set(behavior_trees_DEVEL_PREFIX /home/ruben/arq_software/practica1/devel)
  ...
  set(behavior_trees_INSTALL_PREFIX /home/ruben/arq_software/practica1/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'behavior_trees' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ruben/arq_software/practica1/src/software_arq_robots_course/behavior_trees/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT behavior_trees_NUM_DUMMY_TARGETS)
      set(behavior_trees_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::behavior_trees::wrapped-linker-option${behavior_trees_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR behavior_trees_NUM_DUMMY_TARGETS "${behavior_trees_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::behavior_trees::wrapped-linker-option${behavior_trees_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND behavior_trees_LIBRARIES "${interface_target_name}")
...
set(depends "roscpp;std_msgs;behaviortree_cpp_v3")
